...
| tut_01_terrain_zoc_overwatch | 7 | movement (3 units can move), attack (管制區步兵->道路尖兵, 警戒機槍->道路尖兵), capture (targets=[[6, 0]]), terrain_defense (defensive terrain present), zoc (enemy near player), overwatch (player MG available), deployment_locked | none |
