...
| 1:25 – 1:30 | Code montage / end card | Quick pan across `scripts/` tree in editor, then end card | `24 GDScript files · 80 unit tests · github.com/Fischer-Zhang/WorldWarII` |
...
5. **Code/tests** — end on a quick code pan + `80/80` tests passing.
