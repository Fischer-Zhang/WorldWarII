...
| 0:04-0:10 | Scenario select | Click Single Battle, show category tabs and difficulty buttons. | `41 single-battle scenarios · category tabs · AI difficulty` |
...
| 1:27-1:30 | Validation end card | Terminal or editor shot with validation command/log. | `343 headless checks · report probes · UI smoke` |
