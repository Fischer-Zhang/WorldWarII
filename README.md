...
[![Tests](https://img.shields.io/badge/tests-366%2F366-brightgreen)]() [![Engine](https://img.shields.io/badge/validated-Godot%204.2.2-blue)]() [![License](https://img.shields.io/badge/license-MIT-lightgrey)]()
...
| Tests | 366 headless GDScript checks plus static data/report validators |
...
- `git diff --check`.
- 366 headless GDScript checks through `bash tests/run_all.sh`.
