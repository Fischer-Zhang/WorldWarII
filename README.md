...
[![Tests](https://img.shields.io/badge/tests-306%2F306-brightgreen)]() [![Engine](https://img.shields.io/badge/validated-Godot%204.2.2-blue)]() [![License](https://img.shields.io/badge/license-MIT-lightgrey)]()
...
| Tests | 306 headless GDScript checks plus static data/report validators |
...
- `git diff --check`.
- 306 headless GDScript checks through `bash tests/run_all.sh`.
