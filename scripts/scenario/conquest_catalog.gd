...
const REGION_SCENARIOS := {
	...
	"azores": "conq_atlantic_convoy",
	"iceland": "conq_atlantic_convoy",
	"congo": "conq_cbi_jungle",
	"persia": "conq_middle_east_oilfields",
	"taiwan": "conq_pacific_island",
	"kamchatka": "conq_pacific_island",
	"aleutians": "conq_pacific_island",
	...
	"korea": "conq_china_plains",
	"philippines": "pacific_04_manila_1945",
	"australia": "conq_pacific_island",
